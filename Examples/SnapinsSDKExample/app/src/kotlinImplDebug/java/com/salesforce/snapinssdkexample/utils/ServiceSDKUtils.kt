...
object ServiceSDKUtils {
    ...
    fun getChatConfigurationBuilder(context: Context): ChatConfiguration.Builder {
        ...
        return ChatConfiguration.Builder(
            getStringPref(
                context, ChatSettingsActivity.KEY_ORG_ID,
                context.getString(R.string.pref_chat_org_id_default)
            ),
            getStringPref(
                context, ChatSettingsActivity.KEY_BUTTON_ID,
                context.getString(R.string.pref_chat_button_id_default)
            ),
            getStringPref(
                context, ChatSettingsActivity.KEY_DEPLOYMENT_ID,
                context.getString(R.string.pref_chat_deployment_id_default)
            ),
            getStringPref(
                context, ChatSettingsActivity.KEY_LIVE_AGENT_POD,
     ...
     */
    fun getChatUIConfigurationBuilder(
        context: Context,
        chatConfiguration: ChatConfiguration
    ): ChatUIConfiguration.Builder {
        // Check if the banner and/or avatar are enabled in settings
        val chatbotBannerEnabled =
            getBooleanPref(context, ChatSettingsActivity.KEY_CHATBOT_BANNER_ENABLED)
        val chatbotAvatarEnabled =
            getBooleanPref(context, ChatSettingsActivity.KEY_CHATBOT_AVATAR_ENABLED)
    ...
    fun getKnowledgeUI(context: Context, userAccount: UserAccount?): KnowledgeUI {
        ...
        var coreConfiguration = KnowledgeConfiguration.create(
            getStringPref(
                context, KnowledgeSettingsActivity.KEY_COMMUNITY_URL,
        ...
        val uiConfiguration = KnowledgeUIConfiguration.create(
            coreConfiguration,
            getStringPref(
                context, KnowledgeSettingsActivity.KEY_DATA_CATEGORY_GROUP,
                context.getString(R.string.pref_kb_data_category_group_default)
            ),
            getStringPref(
                context, KnowledgeSettingsActivity.KEY_ROOT_DATA_CATEGORY,
    ...
    fun getCaseConfiguration(
        ...
        val caseConfigurationBuilder = CaseConfiguration.Builder(
            getStringPref(
                context, CaseSettingsActivity.KEY_COMMUNITY_URL,
                context.getString(R.string.pref_case_community_url_default)
            ),
            getStringPref(
                context, CaseSettingsActivity.KEY_CREATE_CASE_ACTION_NAME,
        ...
        userAccount?.let { user ->
            caseConfigurationBuilder.caseListName(
                getStringPref(
                    context,
